...
<form action="p_report_upload.php" method="post" enctype="multipart/form-data" name="form1">
      ...
      <tr>
      <td colspan="3" width="208" height="34"><div align="center"><h2>Upload Report</h2><hr></div></td>
      </tr>
        <tr>
          <td width="208" height="34"><div align="right">Patient Name</div></td>
          <td width="23">&nbsp;</td>
          <td width="227"><label for="email"></label>
            <label for="email"></label>
            <div class="select-style"><select name="email" size="1" id="email">
        ...
        <tr>
          <td height="34"><div align="right">Time <small>(HH:MM:SS)</small></div></td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td height="50"><div align="right">Report File</div></td>
          <td>&nbsp;</td>
