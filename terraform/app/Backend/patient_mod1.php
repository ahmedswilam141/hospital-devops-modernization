...
function checkTime(i) {
      ...
      <table width="595" border="0">
        <tr>
          ...
          <input type="text" name="pname" id="textfield" required value="<?php 
			...
			$pid=$_GET['pid'];
			$qry=mysqli_query($con, "select * from patient where patientID='$pid'");
        ...
        <tr>
            ...
            <input type="text" name="email" id="email" required value="<?php $pid=$_GET['pid'];
		  print $pid;
          ?>"></td>
        </tr>
        <tr>
            ...
            <td>&nbsp;</td>
            <td width="283"><label for="doctor"></label>
       	  <input type="password" name="pass" id="doctor" required></td>
        ...
        <tr>
          <td height="53"><div align="right">Patient Image</div></td>
          <td>&nbsp;</td>
  ...
  <div id="apDiv16">
    <div align="center"><font color="#CCCCCC"><strong><h2>Patient's Modification</h2></strong></font></div>
  </div>
</div>
