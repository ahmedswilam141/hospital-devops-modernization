...
function checkTime(i) {
  ...
  <div id="apDiv15">
    <form action="doctor_reg.php" method="post" enctype="multipart/form-data" name="doctor">
      <table width="595" border="0">
        ...
        <tr>
          <td height="39"><div align="right"><strong>Specilist</strong></div></td>
          <td>&nbsp;</td>
          <td><label for="textfield"></label>
          <input type="text" name="spec" id="textfield" required="required"></td>
        </tr>
        <tr>
        <td height="39"><div align="right"><strong>Doctor Image</strong></div></td>
        <td>&nbsp;</td>
        ...
        <tr>
          <td height="39" colspan="3"><div align="center">
            <input type="submit" name="button" id="button" value="Next" onClick="return validate()">
  ...
  <div id="apDiv16">
    <div align="center"><font color="#CCCCCC"><strong><h2>Doctor's Registration</h2></strong></font></div>
  </div>
</div>
