  ...
  <form name="form1" method="post" action="">
    <table width="792" height="51" border="1" cellpadding="1" cellspacing="1">
      ...
      <tr>
		...
		include("connection.php");
		$uid=$_SESSION['id'];
		$qry1=mysqli_query($con, "select * from doctor where doctorID='$uid'");
		while($row=mysqli_fetch_array($qry1))
		{
		$qry2=mysqli_query($con, "select * from patient natural join appointment where patient.patientID=appointment.patientID");
		if($qry2)
		{
